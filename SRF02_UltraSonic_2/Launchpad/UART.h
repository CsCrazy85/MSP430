...
// ================== LOW POWER DELAY SELECTION ===================
// If low-power delay is needed, uncomment line below.

#define LP_DELAY


// ================== UART TX/RX SELECTION =========================
// If send operations are needed, uncomment ACTIVATE_TX
// If receive operations are needed, uncomment ACTIVATE_RX below
